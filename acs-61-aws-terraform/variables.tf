...
variable "rds-engine-jdbc" {
  type = "string"
  description = "RDS Engine Jdbc type"
}
...
### Alfresco ###
variable "repo-catalina-opts" {
  type = "string"
  description = "Alfresco Repo Tomcat CATALINA_OPTS environment variable"
}
...
variable "solr-opts" {
  type = "string"
  description = "Alfresco Solr SOLR_OPTS environment variable"
}
variable "solr-catalina-opts" {
  type = "string"
  description = "Alfresco Solr Tomcat CATALINA_OPTS environment variable"
}
