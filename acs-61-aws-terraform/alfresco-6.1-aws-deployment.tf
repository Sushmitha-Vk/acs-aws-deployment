...
module "vpc" {
  ...
  resource-owner = "${var.resource-owner}"
  resource-customer = "${var.resource-customer}"
...
module "rds" {
  ...
  rds-instance-count = "${var.rds-instance-count}"
...
module "alfresco-repo" {
  ...
  rds-password = "${var.rds-password}"
  rds-port = "${var.rds-port}"  
  rds-engine = "${var.rds-engine-jdbc}"  
  ...
  catalina-opts = "${var.repo-catalina-opts}"
  ...
  solr-secureComms = "${var.solr-secureComms}"
  enable-timestamp-propagation = "${var.enable-timestamp-propagation}"
  thumbnail-generate = "${var.thumbnail-generate}"
}
...
module "alfresco-solr" {
  ...
  solr-ebs-volume-size = "${var.solr-ebs-volume-size}"
  solr-ebs-volume-type = "${var.solr-ebs-volume-type}"
  solr-ebs-volume-iops = "${var.solr-ebs-volume-iops}"
  cachedcontent-ebs-volume-size = "${var.cachedcontent-ebs-volume-size}"
  alb-arn = "${module.alb.alb-arn}"
  alb-listener-arn = "${module.alb.alb-listener-arn}"
  internal-nlb-arn = "${module.internal-nlb.internal-nlb-arn}"
  ...
  shared-file-store-port = "${var.shared-file-store-port}"  
  elasticsearch-url = "${var.elasticsearch-url}"
  catalina-opts = "${var.solr-catalina-opts}"
  solr-opts = "${var.solr-opts}"
  solr-secureComms = "${var.solr-secureComms}"
  enable-timestamp-propagation = "${var.enable-timestamp-propagation}"
  thumbnail-generate = "${var.thumbnail-generate}"
}
